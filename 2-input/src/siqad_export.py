...
def write_siqad_033_sqd(path, rows):
    ...
    with open(path, "w", encoding="utf-8") as f:
        ...
        f.write(f"  <version>0.3.3</version>\n")
...
def write_candidate_export(root_dir, gate_name, candidate_id,
                           layout, expected_truth_table,
                           snap_to_lattice=True):
    cdir = os.path.join(root_dir, "candidates",
    ...
    return {"candidate_dir": cdir, "csv": csv_p,
            "sqd": sqd_p, "json": json_p}